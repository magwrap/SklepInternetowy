export const texts = {
  ...
  deliveryAndPay: {
    chooseDelMeth: 'Wybierz metode dostawy',
    choosePayMeth: 'Wybierz sposób płatności',
    deliveryMethods: {
      a: 'DHL',
      b: 'Inpost',
      c: 'Ups',
  ...
  auth: {
    ...
    registrationScreen: 'Ekran Rejestracji',
    email: 'email',
    password: 'hasło',
    confirmPassword: 'potwierdz hasło',
    confirmPasswordPlaceholder: 'Potwierdz twoje hasło',
    loginButton: 'Zaloguj',
    registerButton: 'Zarejestruj',
    goToLoginButton: 'Przejdź do logowania',
    goToRegisterButton: 'Przejdź do rejestracji',
  },
  ...
  headerTitles: {
    ...
    Cart: 'Koszyk',
    Payment: 'Zapłata',
    DeliveryAndPay: 'Dostawa i zapłata',
  },
};
